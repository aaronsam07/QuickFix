...
const UserWorkerCard = ({ worker }) => {
  const { _id, service, workername, location, price, available, reviews } =
    worker;
  // const { _id, service, workername, location, price, available, reviews } = worker;
      ...
      <Card>
        <CardBody>
          ...
          <h3 className="worker__title">
            ...
            <Link to={`/user/works/${_id}`}>{service}</Link>
          </h3>
          ...
          <div className="card__bottom d-flex align-items-center justify-content-between mt-3">
            <button className="btn booking__btn">
              <h5>
                {" "}
                <Link to={`/user/works/${_id}`}>Negotiate</Link>
              </h5>
            </button>
            ...
            <button className="btn booking__btn">
              <h5>
                {" "}
                <Link to={`/user/works/${_id}`}>Book Now</Link>
              </h5>
            </button>
          </div>
        </CardBody>
